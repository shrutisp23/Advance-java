...
public class TestConnection {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		ResultSet rs = stmt.executeQuery("select *, (physics + chemistry +maths) as total, ((physics+chemistry+maths)/3) as percentage from marksheet order by  (physics + chemistry +maths) desc limit 0,10;");
		while(rs.next()) {
